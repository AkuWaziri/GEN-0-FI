...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div className="w-full p-4 sm:p-6 lg:p-8 space-y-5 sm:space-y-6 animate-in fade-in duration-200">
      ...
      <div className="p-4 sm:p-5 rounded-xl bg-[#0d0f12] border border-zinc-800 space-y-4 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {isCorrectNetwork ? (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-zinc-900 border border-zinc-700 text-zinc-200 text-xs font-mono font-semibold">
      ...
      <div className="p-4 sm:p-5 rounded-xl bg-[#0d0f12] border border-zinc-800 space-y-3 shadow-sm">
        ...
        <form onSubmit={handleInspect} className="flex gap-2">
          <input
            ...
            placeholder="0x..."
            className="flex-1 px-3 py-1.5 rounded-lg bg-[#131519] border border-zinc-800 text-xs text-white font-mono placeholder:text-zinc-500 focus:border-zinc-500 focus:outline-none"
          />
          <button
            type="submit"
            className="py-1.5 px-3.5 rounded-lg bg-white hover:bg-zinc-200 text-xs font-bold text-black transition-colors cursor-pointer shadow-sm"
          >
            Inspect
          </button>
        </form>
